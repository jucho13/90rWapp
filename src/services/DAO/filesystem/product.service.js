import productModelFS from "./models/productModel.js";
import fs from "fs";
...
export default class ProductManager {
  ...
  createProduct = async (title, description, price, thumbnail, code, stock, status,id) => {
    ...
    if(id === 0){
      ...
      newProduct = new productModelFS(title, description, price, thumbnail, code, stock, status, newProductId);
    }else{
      newProduct = new productModel(title, description, price, thumbnail, code, stock, status, id);
    }
    ...
    updateProduct= async (title, description, price, thumbnail, code, stock,status,id) =>{
